...
public class FavoritosView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rutas.add(new Ruta("3 de Octubre", "A", "5:00 AM - 9:00 PM", true));
        rutas.add(new Ruta("4 de Octubre", "B", "5:00 AM - 9:00 PM", true));
        rutas.add(new Ruta("5 de Octubre", "D", "5:00 AM - 9:00 PM", true));
